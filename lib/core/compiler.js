...
(function() {
  var _, argv, auto_reload, build_js_split, compilers, config, debug, dirs, error, error1, exception, files, fs, fsu, get_split_base_dir, helpers_path, humanize, info, io_path, io_path2, loader, loader_path, log_compiled, logger, minify, path, prefix, reloader_path, server, source_maps_header, sourcemaps, split_loader, split_loader_path, sufix, upath, warn, zlib;
